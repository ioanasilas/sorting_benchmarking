...
import os
import signal
from generate_lists import generate_random_list
...
list_type = generate_random_list  # function to generate random lists for sorting
...
detailed_csv_path = os.path.join(output_directory, "detailed_random_runs.csv")
summary_csv_path = os.path.join(output_directory, "summary_random_runs.csv")
