...
import os
import signal
from generate_lists import generate_reverse_list
...
list_type = generate_reverse_list  # function to generate reversed lists for sorting
...
detailed_csv_path = os.path.join(output_directory, "detailed_reversed_runs.csv")
summary_csv_path = os.path.join(output_directory, "summary_reversed_runs.csv")
