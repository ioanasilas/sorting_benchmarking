...
import os
import signal
from generate_lists import generate_ordered_list
...
list_type = generate_ordered_list  # function to generate ordered lists for sorting
...
detailed_csv_path = os.path.join(output_directory, "detailed_ordered_runs.csv")
summary_csv_path = os.path.join(output_directory, "summary_ordered_runs.csv")
