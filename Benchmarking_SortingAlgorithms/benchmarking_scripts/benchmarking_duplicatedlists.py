...
import os
import signal
from generate_lists import generate_duplicates_list
...
list_type = generate_duplicates_list  # Function to generate duplicated lists for sorting.
...
detailed_csv_path = os.path.join(output_directory, "detailed_duplicated_runs.csv")
summary_csv_path = os.path.join(output_directory, "summary_duplicated_runs.csv")
